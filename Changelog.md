...
The change-log for v5.11.1->5.11.2 can be found in the repository file [changelog.5.11.2.txt](../blob/master/changelog.5.11.2.txt).  Going forward, change logs can be generated automatically using the command
```git log [tag1]..[tag2]```.
